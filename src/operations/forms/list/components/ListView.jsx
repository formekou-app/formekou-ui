...
import { Check as CheckIcon, Clear as UnCheckIcon } from "@mui/icons-material";
...
function ListHeader() {
  return (
    <div className="flex items-center w-full">
      <p
        className="px-3 list-view-header"
        style={{ width: "calc(100% - 690px)" }}
      >
        Title
      </p>
      <p className="px-3 w-[200px] list-view-header">Date created</p>
      <p className="px-3 w-[200px] list-view-header">Last updated</p>
      <p className="px-3 w-[100px] list-view-header">Questions</p>
      <p className="px-3 w-[90px] list-view-header">Private</p>
      <p className="px-3 w-[100px] list-view-header">Actions</p>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <Typography className="text-[14px]">{form.title}</Typography>
      </div>
