...
export function ManualLoginForm() {
  ...
  return (
    <form action="submit" className="space-y-6 py-6" onSubmit={handleSubmit(loginManually)}>
      ...
      {
        isCreate ?
        <input type="text" placeholder="LastName" className="base-input"  {...register("lastName")}/>
        :(
          <a
            href="#"
      ...
      <button className="base-btn main-btn w-full">{isCreate ? "Create Account": "Login"}</button>
      <a href="#" className="block text-sm tracking-wide text-blue-800" onClick={()=>setIsCreate(prev => !prev)}>
