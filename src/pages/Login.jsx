    ...
    <>
      <div class="2xl:container h-screen m-auto">
        <div hidden class="fixed inset-0 w-7/12 lg:block">
          <img class="w-full h-full object-cover" src={image_login} />
        </div>
        <div
          hidden
          role="hidden"
        ...
        <div class="relative h-full ml-auto lg:w-6/12">
          <div class="m-auto py-12 px-6 sm:p-20 xl:w-10/12">
            <div class="space-y-4">
              <a href="">
                <img src={logo} class="w-40" alt="formekou logo" />
              </a>
            ...
            <form action="" class="space-y-6 py-6">
              ...
              <div class="flex flex-col items-end">
                ...
                <button type="reset" class="w-max p-3 -mr-3">
                  <span class="text-sm tracking-wide text-blue-800">
                    Forgot password ?
                  </span>
                </button>
              </div>
              ...
              <div>
                <button class="w-full px-6 py-3 rounded-xl bg-blue-900 transition hover:bg-sky-600 focus:bg-sky-600 active:bg-sky-800">
